...
pub fn run() {
    ...
    let app = builder
        ...
        .setup(|app| {
            logging::startup(&format!(
                "StageWhisper Lite {} on {}",
            ...
            logging::startup("app state managed");
            ...
            logging::startup("relay settings loaded");
            ...
            logging::startup("app settings loaded");
            ...
            logging::startup("setup complete");
    ...
    logging::startup("entering event loop");
