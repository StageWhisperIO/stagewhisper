...
function MicrophoneSection() {
  const { statuses, requestMicrophone, openMicrophoneSettings } = usePermissions();
      ...
      <div className="flex items-center justify-between gap-4">
        <div>
          ...
          <p className="mt-1 text-xs text-muted">
            ...
            summary. Your mic is never sent to the relay.
          </p>
        </div>
        <button
          role="switch"
      ...
      <div className="settings-scroll flex-1 overflow-y-auto px-6 py-5 space-y-5">
        {modelStatus.ready ? (
          <div className="flex items-start gap-3 rounded-lg bg-success-bg px-4 py-3">
            ...
            <div>
              <p className="text-sm font-medium text-heading">Models ready</p>
          ...
          <div className="space-y-3">
            <div className="flex items-center gap-2">
              ...
              <p className="text-sm font-medium text-heading">Downloading models…</p>
            </div>
          ...
          <div className="space-y-3">
            <div>
              <p className="text-sm font-medium text-heading">Models not downloaded</p>
              <p className="mt-1 text-xs text-muted">
                Download the on-device transcription models to enable local pipeline mode (~1.2 GB).
              </p>
            </div>
            <button
        ...
        <div className="border-t border-rule pt-5">
          ...
          <p className="mt-1 text-xs text-muted">~1.2 GB total for transcription models.</p>
